  ...
  const features = [
    {
      ...
      description: 'Organize your tasks with categories, priorities, and due dates.',
      icon: (
    ...
    },
    {
      ...
      description: 'Track your productivity with visual progress indicators.',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white sm:text-5xl md:text-6xl">
                  ...
                  <span className="block text-blue-600 dark:text-blue-400">with TodoApp</span>
                </h1>
                <p className="mt-3 text-base text-gray-500 dark:text-gray-400 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  Stay organized, focused, and in control with our powerful todo list application. 
                  Manage tasks, set reminders, and boost your productivity.
                </p>
